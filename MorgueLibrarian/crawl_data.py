...
SPECIES = {'barachi': 'Br', 'barachian': 'Br', 'black draconian': 'Dr', 'centaur': 'Ce', 'deep dwarf': 'DD',
           'deep elf': 'DE', 'demigod': 'Dg', 'demonspawn': 'Ds', 'djinni': 'Dj', 'draconian': 'Dr', 'felid': 'Fe',
           'formicid': 'Fo', 'gargoyle': 'Gr', 'ghoul': 'Gh', 'gnoll': 'Gn', 'green draconian': 'Dr',
           'grey draconian': 'Dr', 'grotesk': 'Gr', 'halfling': 'Ha', 'high elf': 'HE', 'hill orc': 'HO',
           'human': 'Hu', 'kenku': 'Te', 'kobold': 'Ko', 'lava orc': 'LO', 'merfolk': 'Mf', 'minotaur': 'Mi',
           'mottled draconian': 'Dr', 'mountain dwarf': 'MD', 'mummy': 'Mu', 'naga': 'Na', 'octopode': 'Op',
           'ogre': 'Og', 'pale draconian': 'Dr', 'purple draconian': 'Dr', 'red draconian': 'Dr', 'sludge elf': 'SE',
           'spriggan': 'Sp', 'tengu': 'Te', 'troll': 'Tr', 'vampire': 'Va', 'vine stalker': 'VS',
           'white draconian': 'Dr', 'yellow draconian': 'Dr'}
...
BACKGROUNDS = {'abyssal': 'AK', 'abyssal knight': 'AK', 'air': 'AE', 'air elementalist': 'AE', 'arcane': 'AM',
               ...
               'chaos knight': 'CK', 'conjurer': 'Cj', 'crusader': 'Cr', 'death': 'DK', 'death knight': 'DK',
               'earth': 'EE', 'earth elementalist': 'EE', 'enchanter': 'En', 'fighter': 'Fi', 'fire': 'FE',
               'fire elementalist': 'FE', 'gladiator': 'Gl', 'healer': 'He', 'hunter': 'Hu', 'ice': 'IE',
               'ice elementalist': 'IE', 'jester': 'Je', 'monk': 'Mo', 'necromancer': 'Ne', 'paladin': 'Pa',
               'priest': 'Pr', 'reaver': 'Re', 'skald': 'Sk', 'stalker': 'St', 'summoner': 'Su', 'thief': 'Th',
